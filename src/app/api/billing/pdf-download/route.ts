...
export const GET = withApiRouteHandler('GET /api/billing/pdf-download', async (req: NextRequest) => {
  try {
...
export const POST = withApiRouteHandler('POST /api/billing/pdf-download', async (req: NextRequest) => {
  try {
